...
var url = ["http://oa3dp2eyv.bkt.clouddn.com/isport-gf-1.0.0.apk","https://itunes.apple.com/us/app/ai-yun-dong-shen-bian-yun/id1180401298?l=zh&ls=1&mt=8"];
var url = "http://a.app.qq.com/o/simple.jsp?pkgname=com.elephant.qq";
$(function(){
    if((bIsIpad || bIsIphoneOs || bIsMidp || bIsUc7 || bIsUc || bIsAndroid || bIsCE || bIsWM)) {
        $(".mobile_download").show();
        $(".pc_download").hide();
        $(".bottom_tips").hide();
        $(".mobile_download").attr("href",url);
